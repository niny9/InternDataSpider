...
class XiaohongshuSpider1CrawlSpider(RedisSpider):
    ...
    def __init__(self, name=None, **kwargs):
        ...
        # 启动普罗米修斯HTTP服务器
        start_http_server(8004)  # 在8004端口上暴露指标

        # 加载代理池
        proxy_path = "D:\\Desktop\\xiaohongshu_spider1_Prometheus\\xiaohongshu_spider1\\xiaohongshu_spider1\\proxies.txt"
        ...
        user_agents = [
            ...
            'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/133.0.6943.98 Safari/537.36',
        ]
